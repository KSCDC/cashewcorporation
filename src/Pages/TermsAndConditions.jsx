  ...
  return (
    <main>
      ...
      <div className=" mx-auto py-8 px-4">
        <h1 className="text-3xl font-bold text-gray-800 mb-8">TERMS AND CONDITION</h1>
        <div className="mb-8">
          <h3 className="text-xl font-semibold mb-4">User Agreement</h3>
        ...
        <div className="mb-8">
          ...
          <div className="lg:px-6 text-gray-700">
